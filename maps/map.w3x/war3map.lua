...
function CreateUnitsForPlayer0()
    ...
    local t
    local life
    gg_unit_Hpal_0002 = BlzCreateUnitWithSkin(p, FourCC("Hpal"), 393.1, -644.9, 269.900, FourCC("Hpal"))
...
function CreateRegions()
    local we
    gg_rct_Region_000 = Rect(736.0, -192.0, 1376.0, 320.0)
    gg_rct_Region_001 = Rect(-1696.0, -800.0, -1664.0, -768.0)
end
